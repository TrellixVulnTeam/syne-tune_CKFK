...
def yahpo_iaml_rpart_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_iaml_benchmark_definitions("rpart", restrict_fidelities)


def yahpo_iaml_rpart_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_iaml_selected_benchmark_definitions("rpart", restrict_fidelities)


def yahpo_iaml_glmnet_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_iaml_benchmark_definitions("glmnet", restrict_fidelities)


def yahpo_iaml_glmnet_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_iaml_selected_benchmark_definitions("glmnet", restrict_fidelities)


def yahpo_iaml_ranger_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_iaml_benchmark_definitions("ranger", restrict_fidelities)


def yahpo_iaml_ranger_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_iaml_selected_benchmark_definitions("ranger", restrict_fidelities)


def yahpo_iaml_xgboost_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_iaml_benchmark_definitions("xgboost", restrict_fidelities)


def yahpo_iaml_xgboost_selected_benchmark_definitions(
    restrict_fidelities=False,
) -> dict:
    return yahpo_iaml_selected_benchmark_definitions("xgboost", restrict_fidelities)
...
yahpo_rbv2_max_wallclock_time = {
    ...
    "glmnet-f1-41156": 641,  # {'RS': 83, 'BO': 641, 'ASHA': 112}
    "glmnet-f1-1590": 43,  # {'RS': 40, 'BO': 43, 'ASHA': 26}
    "glmnet-f1-41157": 621,  # {'RS': 621, 'BO': 314, 'ASHA': 315}
    "glmnet-f1-1461": 326,  # {'RS': 273, 'BO': 326, 'ASHA': 182}
    "glmnet-f1-1462": 11,  # {'RS': 11, 'BO': 6, 'ASHA': 11}
    "glmnet-f1-1464": 411,  # {'RS': 186, 'BO': 42, 'ASHA': 411}
    "glmnet-f1-15": 6,  # {'RS': 6, 'BO': 2, 'ASHA': 6}
    "glmnet-f1-41142": 691,  # {'RS': 691, 'BO': 551, 'ASHA': 246}
    "glmnet-f1-40701": 417,  # {'RS': 417, 'BO': 81, 'ASHA': 417}
    "glmnet-f1-40994": 103,  # {'RS': 91, 'BO': 103, 'ASHA': 86}
    "glmnet-f1-29": 3,  # {'RS': 3, 'BO': 1, 'ASHA': 3}
    "glmnet-f1-31": 783,  # {'RS': 171, 'BO': 35, 'ASHA': 783}
    "glmnet-f1-6332": 6,  # {'RS': 6, 'BO': 6, 'ASHA': 6}
    "glmnet-f1-37": 33,  # {'RS': 33, 'BO': 30, 'ASHA': 33}
    "glmnet-f1-23381": 826,  # {'RS': 256, 'BO': 826, 'ASHA': 256}
    "glmnet-f1-151": 16,  # {'RS': 15, 'BO': 16, 'ASHA': 15}
    "glmnet-f1-41159": 868,  # {'RS': 344, 'BO': 868, 'ASHA': 602}
    ...
    "glmnet-f1-1053": 783,  # {'RS': 783, 'BO': 190, 'ASHA': 783}
    "glmnet-f1-1067": 453,  # {'RS': 453, 'BO': 179, 'ASHA': 236}
    "glmnet-f1-1063": 392,  # {'RS': 37, 'BO': 23, 'ASHA': 392}
    "glmnet-f1-41162": 658,  # {'RS': 260, 'BO': 285, 'ASHA': 658}
    "glmnet-f1-3": 13,  # {'RS': 13, 'BO': 7, 'ASHA': 13}
    "glmnet-f1-1485": 85,  # {'RS': 85, 'BO': 58, 'ASHA': 11}
    "glmnet-f1-1056": 327,  # {'RS': 197, 'BO': 48, 'ASHA': 327}
    "glmnet-f1-334": 326,  # {'RS': 326, 'BO': 186, 'ASHA': 221}
    "glmnet-f1-24": 6,  # {'RS': 2, 'BO': 6, 'ASHA': 3}
    "glmnet-f1-1486": 40,  # {'RS': 40, 'BO': 30, 'ASHA': 33}
    "glmnet-f1-23517": 77,  # {'RS': 77, 'BO': 12, 'ASHA': 58}
    "glmnet-f1-1487": 772,  # {'RS': 772, 'BO': 41, 'ASHA': 372}
    "glmnet-f1-1068": 464,  # {'RS': 436, 'BO': 464, 'ASHA': 436}
    "glmnet-f1-1050": 206,  # {'RS': 206, 'BO': 34, 'ASHA': 86}
    "glmnet-f1-1049": 348,  # {'RS': 186, 'BO': 29, 'ASHA': 348}
    "glmnet-f1-1489": 784,  # {'RS': 784, 'BO': 352, 'ASHA': 784}
    "glmnet-f1-470": 162,  # {'RS': 162, 'BO': 46, 'ASHA': 111}
    "glmnet-f1-1494": 72,  # {'RS': 72, 'BO': 30, 'ASHA': 72}
    "glmnet-f1-41161": 790,  # {'RS': 790, 'BO': 789, 'ASHA': 672}
    "glmnet-f1-312": 17,  # {'RS': 17, 'BO': 13, 'ASHA': 17}
    "glmnet-f1-38": 317,  # {'RS': 317, 'BO': 18, 'ASHA': 317}
    "glmnet-f1-44": 72,  # {'RS': 72, 'BO': 20, 'ASHA': 72}
    "glmnet-f1-1040": 28,  # {'RS': 28, 'BO': 24, 'ASHA': 19}
    "glmnet-f1-41146": 58,  # {'RS': 27, 'BO': 58, 'ASHA': 27}
    "glmnet-f1-50": 11,  # {'RS': 11, 'BO': 11, 'ASHA': 11}
    "glmnet-f1-1510": 7,  # {'RS': 6, 'BO': 6, 'ASHA': 7}
    "glmnet-f1-40983": 822,  # {'RS': 822, 'BO': 652, 'ASHA': 822}
    "glmnet-auc-41138": 686,  # {'RS': 686, 'BO': 608, 'ASHA': 382}
    "glmnet-auc-4135": 850,  # {'RS': 501, 'BO': 610, 'ASHA': 850}
    "glmnet-auc-40981": 7,  # {'RS': 6, 'BO': 7, 'ASHA': 6}
    "glmnet-auc-4134": 750,  # {'RS': 107, 'BO': 750, 'ASHA': 256}
    ...
    "glmnet-auc-40978": 20,  # {'RS': 20, 'BO': 11, 'ASHA': 14}
    "glmnet-auc-375": 11,  # {'RS': 11, 'BO': 3, 'ASHA': 7}
    "glmnet-auc-1111": 850,  # {'RS': 657, 'BO': 817, 'ASHA': 850}
    "glmnet-auc-40496": 17,  # {'RS': 13, 'BO': 17, 'ASHA': 13}
    "glmnet-auc-41150": 298,  # {'RS': 248, 'BO': 298, 'ASHA': 289}
    "glmnet-auc-4534": 24,  # {'RS': 5, 'BO': 24, 'ASHA': 5}
    "glmnet-auc-40900": 41,  # {'RS': 41, 'BO': 12, 'ASHA': 41}
    "glmnet-auc-40536": 140,  # {'RS': 140, 'BO': 34, 'ASHA': 129}
    "glmnet-auc-41156": 28,  # {'RS': 13, 'BO': 8, 'ASHA': 28}
    "glmnet-auc-1590": 51,  # {'RS': 28, 'BO': 51, 'ASHA': 19}
    "glmnet-auc-1457": 776,  # {'RS': 776, 'BO': 617, 'ASHA': 685}
    "glmnet-auc-469": 582,  # {'RS': 111, 'BO': 582, 'ASHA': 209}
    "glmnet-auc-41157": 621,  # {'RS': 621, 'BO': 142, 'ASHA': 311}
    "glmnet-auc-11": 12,  # {'RS': 11, 'BO': 12, 'ASHA': 11}
    "glmnet-auc-1461": 74,  # {'RS': 74, 'BO': 13, 'ASHA': 56}
    "glmnet-auc-1462": 1,  # {'RS': 1, 'BO': 1, 'ASHA': 1}
    "glmnet-auc-1464": 76,  # {'RS': 58, 'BO': 42, 'ASHA': 76}
    "glmnet-auc-15": 1,  # {'RS': 1, 'BO': 1, 'ASHA': 1}
    "glmnet-auc-40975": 47,  # {'RS': 47, 'BO': 11, 'ASHA': 33}
    "glmnet-auc-41142": 343,  # {'RS': 343, 'BO': 258, 'ASHA': 190}
    "glmnet-auc-40701": 56,  # {'RS': 56, 'BO': 35, 'ASHA': 56}
    "glmnet-auc-40994": 21,  # {'RS': 15, 'BO': 12, 'ASHA': 21}
    "glmnet-auc-23": 166,  # {'RS': 166, 'BO': 18, 'ASHA': 166}
    "glmnet-auc-1468": 17,  # {'RS': 10, 'BO': 17, 'ASHA': 11}
    "glmnet-auc-40668": 375,  # {'RS': 375, 'BO': 279, 'ASHA': 293}
    "glmnet-auc-29": 33,  # {'RS': 12, 'BO': 33, 'ASHA': 12}
    "glmnet-auc-31": 279,  # {'RS': 86, 'BO': 279, 'ASHA': 103}
    "glmnet-auc-6332": 179,  # {'RS': 179, 'BO': 59, 'ASHA': 158}
    "glmnet-auc-37": 17,  # {'RS': 11, 'BO': 17, 'ASHA': 11}
    "glmnet-auc-4541": 695,  # {'RS': 695, 'BO': 471, 'ASHA': 602}
    "glmnet-auc-40670": 13,  # {'RS': 10, 'BO': 10, 'ASHA': 13}
    "glmnet-auc-23381": 597,  # {'RS': 271, 'BO': 597, 'ASHA': 186}
    "glmnet-auc-151": 55,  # {'RS': 55, 'BO': 37, 'ASHA': 50}
    "glmnet-auc-188": 7,  # {'RS': 6, 'BO': 7, 'ASHA': 6}
    "glmnet-auc-41164": 557,  # {'RS': 557, 'BO': 458, 'ASHA': 444}
    "glmnet-auc-1475": 272,  # {'RS': 272, 'BO': 65, 'ASHA': 272}
    "glmnet-auc-1476": 31,  # {'RS': 27, 'BO': 31, 'ASHA': 27}
    "glmnet-auc-41159": 751,  # {'RS': 511, 'BO': 751, 'ASHA': 741}
    "glmnet-auc-1478": 51,  # {'RS': 46, 'BO': 37, 'ASHA': 51}
    "glmnet-auc-41169": 856,  # {'RS': 843, 'BO': 856, 'ASHA': 507}
    "glmnet-auc-23512": 228,  # {'RS': 228, 'BO': 90, 'ASHA': 118}
    "glmnet-auc-1479": 287,  # {'RS': 287, 'BO': 18, 'ASHA': 122}
    "glmnet-auc-41212": 53,  # {'RS': 53, 'BO': 12, 'ASHA': 37}
    "glmnet-auc-1480": 149,  # {'RS': 103, 'BO': 149, 'ASHA': 103}
    "glmnet-auc-300": 595,  # {'RS': 595, 'BO': 170, 'ASHA': 272}
    "glmnet-auc-41168": 796,  # {'RS': 796, 'BO': 395, 'ASHA': 603}
    "glmnet-auc-41143": 58,  # {'RS': 55, 'BO': 28, 'ASHA': 58}
    "glmnet-auc-1053": 117,  # {'RS': 117, 'BO': 37, 'ASHA': 117}
    "glmnet-auc-41027": 110,  # {'RS': 110, 'BO': 43, 'ASHA': 78}
    "glmnet-auc-1067": 76,  # {'RS': 76, 'BO': 13, 'ASHA': 76}
    "glmnet-auc-1063": 36,  # {'RS': 36, 'BO': 12, 'ASHA': 36}
    "glmnet-auc-41162": 642,  # {'RS': 642, 'BO': 613, 'ASHA': 361}
    "glmnet-auc-3": 2,  # {'RS': 1, 'BO': 2, 'ASHA': 1}
    "glmnet-auc-6": 132,  # {'RS': 132, 'BO': 92, 'ASHA': 84}
    "glmnet-auc-1485": 893,  # {'RS': 893, 'BO': 421, 'ASHA': 360}
    "glmnet-auc-1056": 582,  # {'RS': 582, 'BO': 18, 'ASHA': 431}
    "glmnet-auc-12": 5,  # {'RS': 5, 'BO': 5, 'ASHA': 5}
    "glmnet-auc-14": 42,  # {'RS': 25, 'BO': 42, 'ASHA': 18}
    "glmnet-auc-16": 4,  # {'RS': 4, 'BO': 4, 'ASHA': 4}
    "glmnet-auc-18": 14,  # {'RS': 14, 'BO': 12, 'ASHA': 12}
    "glmnet-auc-40979": 9,  # {'RS': 8, 'BO': 9, 'ASHA': 8}
    "glmnet-auc-22": 26,  # {'RS': 21, 'BO': 26, 'ASHA': 18}
    "glmnet-auc-1515": 63,  # {'RS': 34, 'BO': 63, 'ASHA': 28}
    "glmnet-auc-334": 557,  # {'RS': 556, 'BO': 40, 'ASHA': 557}
    "glmnet-auc-1486": 41,  # {'RS': 16, 'BO': 41, 'ASHA': 16}
    "glmnet-auc-23517": 679,  # {'RS': 679, 'BO': 486, 'ASHA': 495}
    "glmnet-auc-41278": 682,  # {'RS': 682, 'BO': 307, 'ASHA': 303}
    "glmnet-auc-1493": 114,  # {'RS': 107, 'BO': 114, 'ASHA': 102}
    "glmnet-auc-28": 6,  # {'RS': 5, 'BO': 6, 'ASHA': 5}
    "glmnet-auc-1487": 282,  # {'RS': 282, 'BO': 23, 'ASHA': 278}
    "glmnet-auc-1068": 277,  # {'RS': 277, 'BO': 104, 'ASHA': 277}
    "glmnet-auc-1050": 87,  # {'RS': 87, 'BO': 12, 'ASHA': 87}
    "glmnet-auc-1049": 56,  # {'RS': 56, 'BO': 12, 'ASHA': 56}
    "glmnet-auc-32": 10,  # {'RS': 9, 'BO': 10, 'ASHA': 9}
    "glmnet-auc-1489": 26,  # {'RS': 26, 'BO': 18, 'ASHA': 16}
    "glmnet-auc-470": 401,  # {'RS': 31, 'BO': 29, 'ASHA': 401}
    "glmnet-auc-1494": 8,  # {'RS': 7, 'BO': 7, 'ASHA': 8}
    "glmnet-auc-41161": 756,  # {'RS': 756, 'BO': 750, 'ASHA': 428}
    "glmnet-auc-182": 39,  # {'RS': 35, 'BO': 39, 'ASHA': 26}
    "glmnet-auc-40984": 3,  # {'RS': 3, 'BO': 3, 'ASHA': 3}
    "glmnet-auc-1501": 26,  # {'RS': 20, 'BO': 26, 'ASHA': 18}
    "glmnet-auc-40685": 261,  # {'RS': 238, 'BO': 261, 'ASHA': 211}
    "glmnet-auc-38": 32,  # {'RS': 32, 'BO': 12, 'ASHA': 32}
    "glmnet-auc-42": 11,  # {'RS': 11, 'BO': 1, 'ASHA': 6}
    "glmnet-auc-44": 7,  # {'RS': 7, 'BO': 2, 'ASHA': 7}
    "glmnet-auc-46": 8,  # {'RS': 5, 'BO': 6, 'ASHA': 8}
    "glmnet-auc-40982": 45,  # {'RS': 45, 'BO': 22, 'ASHA': 32}
    "glmnet-auc-1040": 12,  # {'RS': 12, 'BO': 5, 'ASHA': 8}
    "glmnet-auc-41146": 6,  # {'RS': 4, 'BO': 4, 'ASHA': 6}
    "glmnet-auc-50": 11,  # {'RS': 11, 'BO': 6, 'ASHA': 11}
    "glmnet-auc-54": 14,  # {'RS': 13, 'BO': 7, 'ASHA': 14}
    "glmnet-auc-41216": 694,  # {'RS': 390, 'BO': 257, 'ASHA': 694}
    "glmnet-auc-41166": 865,  # {'RS': 794, 'BO': 865, 'ASHA': 826}
    "glmnet-auc-307": 95,  # {'RS': 95, 'BO': 21, 'ASHA': 48}
    "glmnet-auc-1497": 47,  # {'RS': 35, 'BO': 47, 'ASHA': 35}
    "glmnet-auc-60": 8,  # {'RS': 6, 'BO': 8, 'ASHA': 6}
    "glmnet-auc-1510": 1,  # {'RS': 1, 'BO': 1, 'ASHA': 1}
    ...
    "ranger-f1-1220": 892,  # {'RS': 866, 'BO': 892, 'ASHA': 648}
    ...
    "ranger-f1-40536": 861,  # {'RS': 861, 'BO': 760, 'ASHA': 757}
    "ranger-f1-41156": 791,  # {'RS': 495, 'BO': 481, 'ASHA': 791}
    "ranger-f1-1590": 821,  # {'RS': 577, 'BO': 821, 'ASHA': 322}
    "ranger-f1-41157": 737,  # {'RS': 601, 'BO': 560, 'ASHA': 737}
    "ranger-f1-1461": 831,  # {'RS': 488, 'BO': 831, 'ASHA': 591}
    "ranger-f1-1462": 47,  # {'RS': 47, 'BO': 34, 'ASHA': 40}
    "ranger-f1-1464": 637,  # {'RS': 332, 'BO': 637, 'ASHA': 492}
    "ranger-f1-15": 264,  # {'RS': 110, 'BO': 264, 'ASHA': 92}
    "ranger-f1-41142": 866,  # {'RS': 775, 'BO': 842, 'ASHA': 866}
    ...
    "ranger-f1-37": 758,  # {'RS': 758, 'BO': 240, 'ASHA': 524}
    "ranger-f1-23381": 869,  # {'RS': 573, 'BO': 869, 'ASHA': 677}
    "ranger-f1-151": 890,  # {'RS': 741, 'BO': 890, 'ASHA': 416}
    "ranger-f1-1479": 716,  # {'RS': 716, 'BO': 346, 'ASHA': 707}
    "ranger-f1-1480": 850,  # {'RS': 542, 'BO': 850, 'ASHA': 741}
    "ranger-f1-41143": 739,  # {'RS': 362, 'BO': 739, 'ASHA': 704}
    "ranger-f1-1053": 889,  # {'RS': 811, 'BO': 862, 'ASHA': 889}
    "ranger-f1-1067": 868,  # {'RS': 853, 'BO': 498, 'ASHA': 868}
    "ranger-f1-1063": 867,  # {'RS': 867, 'BO': 789, 'ASHA': 835}
    "ranger-f1-3": 197,  # {'RS': 146, 'BO': 136, 'ASHA': 197}
    "ranger-f1-1485": 855,  # {'RS': 331, 'BO': 699, 'ASHA': 855}
    "ranger-f1-1056": 717,  # {'RS': 254, 'BO': 596, 'ASHA': 717}
    "ranger-f1-334": 846,  # {'RS': 562, 'BO': 194, 'ASHA': 846}
    "ranger-f1-24": 102,  # {'RS': 60, 'BO': 38, 'ASHA': 102}
    "ranger-f1-1486": 584,  # {'RS': 415, 'BO': 538, 'ASHA': 584}
    "ranger-f1-1487": 791,  # {'RS': 791, 'BO': 397, 'ASHA': 497}
    "ranger-f1-1068": 875,  # {'RS': 807, 'BO': 475, 'ASHA': 875}
    "ranger-f1-1050": 885,  # {'RS': 531, 'BO': 885, 'ASHA': 863}
    ...
    "ranger-f1-1494": 728,  # {'RS': 728, 'BO': 359, 'ASHA': 428}
    "ranger-f1-312": 766,  # {'RS': 362, 'BO': 621, 'ASHA': 766}
    "ranger-f1-38": 716,  # {'RS': 716, 'BO': 407, 'ASHA': 308}
    "ranger-f1-44": 818,  # {'RS': 449, 'BO': 777, 'ASHA': 818}
    "ranger-f1-1040": 311,  # {'RS': 311, 'BO': 205, 'ASHA': 308}
    "ranger-f1-41146": 690,  # {'RS': 586, 'BO': 356, 'ASHA': 690}
    "ranger-f1-50": 61,  # {'RS': 61, 'BO': 33, 'ASHA': 56}
    "ranger-f1-1510": 145,  # {'RS': 145, 'BO': 51, 'ASHA': 119}
    "ranger-f1-40983": 481,  # {'RS': 481, 'BO': 127, 'ASHA': 406}
    "ranger-f1-41138": 727,  # {'RS': 684, 'BO': 727, 'ASHA': 610}
    "ranger-f1-1111": 886,  # {'RS': 138, 'BO': 226, 'ASHA': 886}
    "ranger-f1-41159": 858,  # {'RS': 844, 'BO': 858, 'ASHA': 722}
    ...
    "ranger-f1-41150": 842,  # {'RS': 842, 'BO': 634, 'ASHA': 571}
    ...
    "ranger-auc-1590": 894,  # {'RS': 570, 'BO': 894, 'ASHA': 238}
    ...
    "xgboost-f1-1590": 642,  # {'RS': 502, 'BO': 642, 'ASHA': 502}
    ...
    "xgboost-f1-1457": 890,  # {'RS': 0, 'BO': 890, 'ASHA': 0}
    "xgboost-f1-1480": 55,  # {'RS': 13, 'BO': 55, 'ASHA': 12}
    "xgboost-f1-6332": 801,  # {'RS': 801, 'BO': 572, 'ASHA': 778}
    "xgboost-f1-1479": 829,  # {'RS': 604, 'BO': 145, 'ASHA': 829}
    "xgboost-f1-40536": 57,  # {'RS': 55, 'BO': 56, 'ASHA': 57}
    "xgboost-f1-41138": 735,  # {'RS': 730, 'BO': 735, 'ASHA': 210}
    "xgboost-f1-29": 823,  # {'RS': 590, 'BO': 536, 'ASHA': 823}
    "xgboost-f1-1056": 10,  # {'RS': 10, 'BO': 8, 'ASHA': 10}
    ...
    "xgboost-f1-334": 683,  # {'RS': 270, 'BO': 324, 'ASHA': 683}
    "xgboost-f1-41142": 745,  # {'RS': 500, 'BO': 745, 'ASHA': 347}
    "xgboost-f1-38": 129,  # {'RS': 129, 'BO': 43, 'ASHA': 91}
    "xgboost-f1-1050": 82,  # {'RS': 15, 'BO': 82, 'ASHA': 43}
    "xgboost-f1-23381": 80,  # {'RS': 80, 'BO': 80, 'ASHA': 75}
    "xgboost-f1-41157": 808,  # {'RS': 781, 'BO': 465, 'ASHA': 808}
    "xgboost-f1-15": 392,  # {'RS': 392, 'BO': 161, 'ASHA': 62}
    "xgboost-f1-4134": 856,  # {'RS': 678, 'BO': 856, 'ASHA': 297}
    "xgboost-f1-40981": 835,  # {'RS': 835, 'BO': 339, 'ASHA': 728}
    ...
    "xgboost-f1-1464": 816,  # {'RS': 816, 'BO': 230, 'ASHA': 226}
    "xgboost-f1-41146": 535,  # {'RS': 535, 'BO': 372, 'ASHA': 231}
    "xgboost-f1-60": 561,  # {'RS': 44, 'BO': 11, 'ASHA': 561}
    "xgboost-f1-41150": 751,  # {'RS': 751, 'BO': 717, 'ASHA': 677}
    "xgboost-f1-37": 784,  # {'RS': 784, 'BO': 94, 'ASHA': 33}
    "xgboost-f1-1485": 878,  # {'RS': 878, 'BO': 605, 'ASHA': 500}
    "xgboost-f1-1111": 23,  # {'RS': 23, 'BO': 16, 'ASHA': 23}
    "xgboost-f1-4534": 595,  # {'RS': 265, 'BO': 40, 'ASHA': 595}
    "xgboost-f1-151": 638,  # {'RS': 638, 'BO': 331, 'ASHA': 638}
    "xgboost-f1-4154": 10,  # {'RS': 10, 'BO': 6, 'ASHA': 10}
    "xgboost-f1-40978": 758,  # {'RS': 555, 'BO': 758, 'ASHA': 666}
    "xgboost-f1-40994": 828,  # {'RS': 726, 'BO': 828, 'ASHA': 431}
    "xgboost-f1-50": 608,  # {'RS': 485, 'BO': 295, 'ASHA': 608}
    "xgboost-f1-1486": 604,  # {'RS': 325, 'BO': 604, 'ASHA': 385}
    "aknn-f1-41138": 759,  # {'RS': 291, 'BO': 759, 'ASHA': 702}
    "aknn-f1-40981": 728,  # {'RS': 100, 'BO': 106, 'ASHA': 728}
    "aknn-f1-4134": 848,  # {'RS': 848, 'BO': 254, 'ASHA': 206}
    "aknn-f1-1220": 879,  # {'RS': 879, 'BO': 383, 'ASHA': 796}
    "aknn-f1-4154": 765,  # {'RS': 709, 'BO': 765, 'ASHA': 609}
    "aknn-f1-40978": 642,  # {'RS': 642, 'BO': 344, 'ASHA': 348}
    "aknn-f1-1111": 885,  # {'RS': 367, 'BO': 885, 'ASHA': 462}
    "aknn-f1-41150": 404,  # {'RS': 166, 'BO': 378, 'ASHA': 404}
    "aknn-f1-4534": 666,  # {'RS': 398, 'BO': 666, 'ASHA': 520}
    ...
    "aknn-f1-41157": 740,  # {'RS': 567, 'BO': 489, 'ASHA': 740}
    "aknn-f1-1461": 824,  # {'RS': 400, 'BO': 824, 'ASHA': 666}
    "aknn-f1-1462": 26,  # {'RS': 26, 'BO': 11, 'ASHA': 26}
    "aknn-f1-1464": 626,  # {'RS': 551, 'BO': 107, 'ASHA': 626}
    "aknn-f1-15": 126,  # {'RS': 126, 'BO': 30, 'ASHA': 60}
    "aknn-f1-41142": 651,  # {'RS': 536, 'BO': 651, 'ASHA': 576}
    "aknn-f1-40701": 883,  # {'RS': 883, 'BO': 674, 'ASHA': 828}
    "aknn-f1-40994": 561,  # {'RS': 561, 'BO': 72, 'ASHA': 561}
    "aknn-f1-29": 176,  # {'RS': 41, 'BO': 42, 'ASHA': 176}
    "aknn-f1-31": 841,  # {'RS': 841, 'BO': 587, 'ASHA': 841}
    "aknn-f1-6332": 656,  # {'RS': 656, 'BO': 104, 'ASHA': 656}
    "aknn-f1-37": 472,  # {'RS': 472, 'BO': 142, 'ASHA': 421}
    "aknn-f1-23381": 396,  # {'RS': 396, 'BO': 78, 'ASHA': 382}
    "aknn-f1-151": 676,  # {'RS': 676, 'BO': 431, 'ASHA': 583}
    "aknn-f1-41159": 693,  # {'RS': 267, 'BO': 693, 'ASHA': 645}
    "aknn-f1-23512": 230,  # {'RS': 230, 'BO': 72, 'ASHA': 177}
    "aknn-f1-1479": 12,  # {'RS': 11, 'BO': 12, 'ASHA': 11}
    "aknn-f1-1480": 857,  # {'RS': 857, 'BO': 338, 'ASHA': 845}
    "aknn-f1-41143": 632,  # {'RS': 632, 'BO': 469, 'ASHA': 221}
    "aknn-f1-1053": 892,  # {'RS': 892, 'BO': 115, 'ASHA': 699}
    "aknn-f1-1067": 851,  # {'RS': 851, 'BO': 672, 'ASHA': 793}
    "aknn-f1-1063": 721,  # {'RS': 721, 'BO': 579, 'ASHA': 541}
    "aknn-f1-41162": 511,  # {'RS': 268, 'BO': 511, 'ASHA': 357}
    "aknn-f1-3": 161,  # {'RS': 161, 'BO': 67, 'ASHA': 123}
    "aknn-f1-1485": 85,  # {'RS': 35, 'BO': 85, 'ASHA': 2}
    "aknn-f1-1056": 429,  # {'RS': 429, 'BO': 238, 'ASHA': 325}
    "aknn-f1-334": 601,  # {'RS': 106, 'BO': 37, 'ASHA': 601}
    "aknn-f1-24": 7,  # {'RS': 7, 'BO': 7, 'ASHA': 7}
    "aknn-f1-1486": 811,  # {'RS': 744, 'BO': 811, 'ASHA': 703}
    "aknn-f1-23517": 603,  # {'RS': 603, 'BO': 284, 'ASHA': 233}
    "aknn-f1-1487": 737,  # {'RS': 582, 'BO': 456, 'ASHA': 737}
    "aknn-f1-1068": 701,  # {'RS': 701, 'BO': 555, 'ASHA': 701}
    "aknn-f1-1050": 623,  # {'RS': 623, 'BO': 248, 'ASHA': 600}
    "aknn-f1-1049": 782,  # {'RS': 666, 'BO': 328, 'ASHA': 782}
    "aknn-f1-1489": 666,  # {'RS': 666, 'BO': 31, 'ASHA': 657}
    "aknn-f1-470": 371,  # {'RS': 371, 'BO': 161, 'ASHA': 371}
    "aknn-f1-1494": 741,  # {'RS': 541, 'BO': 96, 'ASHA': 741}
    "aknn-f1-41161": 839,  # {'RS': 302, 'BO': 839, 'ASHA': 640}
    "aknn-f1-312": 122,  # {'RS': 91, 'BO': 117, 'ASHA': 122}
    "aknn-f1-38": 847,  # {'RS': 847, 'BO': 311, 'ASHA': 723}
    "aknn-f1-44": 452,  # {'RS': 184, 'BO': 114, 'ASHA': 452}
    "aknn-f1-1040": 769,  # {'RS': 298, 'BO': 305, 'ASHA': 769}
    "aknn-f1-41146": 297,  # {'RS': 297, 'BO': 180, 'ASHA': 297}
    "aknn-f1-50": 26,  # {'RS': 6, 'BO': 6, 'ASHA': 26}
    "aknn-f1-1510": 76,  # {'RS': 16, 'BO': 12, 'ASHA': 76}
    "aknn-f1-40983": 737,  # {'RS': 451, 'BO': 109, 'ASHA': 737}
    "aknn-auc-41138": 469,  # {'RS': 429, 'BO': 469, 'ASHA': 437}
    "aknn-auc-40981": 447,  # {'RS': 301, 'BO': 68, 'ASHA': 447}
    "aknn-auc-4134": 850,  # {'RS': 850, 'BO': 539, 'ASHA': 699}
    "aknn-auc-40927": 790,  # {'RS': 646, 'BO': 790, 'ASHA': 707}
    "aknn-auc-1220": 888,  # {'RS': 573, 'BO': 479, 'ASHA': 888}
    "aknn-auc-4154": 786,  # {'RS': 497, 'BO': 118, 'ASHA': 786}
    ...
    "aknn-auc-40978": 815,  # {'RS': 815, 'BO': 455, 'ASHA': 197}
    "aknn-auc-375": 58,  # {'RS': 25, 'BO': 58, 'ASHA': 24}
    "aknn-auc-1111": 755,  # {'RS': 217, 'BO': 545, 'ASHA': 755}
    "aknn-auc-40496": 131,  # {'RS': 100, 'BO': 36, 'ASHA': 131}
    "aknn-auc-41150": 654,  # {'RS': 654, 'BO': 368, 'ASHA': 566}
    "aknn-auc-4534": 802,  # {'RS': 802, 'BO': 222, 'ASHA': 647}
    "aknn-auc-40900": 244,  # {'RS': 82, 'BO': 87, 'ASHA': 244}
    "aknn-auc-40536": 781,  # {'RS': 706, 'BO': 42, 'ASHA': 781}
    "aknn-auc-41156": 677,  # {'RS': 677, 'BO': 339, 'ASHA': 594}
    "aknn-auc-1590": 886,  # {'RS': 886, 'BO': 384, 'ASHA': 588}
    "aknn-auc-1457": 585,  # {'RS': 585, 'BO': 356, 'ASHA': 338}
    "aknn-auc-469": 837,  # {'RS': 837, 'BO': 98, 'ASHA': 552}
    "aknn-auc-41157": 751,  # {'RS': 751, 'BO': 178, 'ASHA': 695}
    "aknn-auc-11": 176,  # {'RS': 121, 'BO': 61, 'ASHA': 176}
    "aknn-auc-1461": 875,  # {'RS': 875, 'BO': 176, 'ASHA': 847}
    "aknn-auc-1464": 757,  # {'RS': 521, 'BO': 36, 'ASHA': 757}
    "aknn-auc-15": 51,  # {'RS': 51, 'BO': 12, 'ASHA': 51}
    "aknn-auc-40975": 511,  # {'RS': 291, 'BO': 152, 'ASHA': 511}
    "aknn-auc-41142": 790,  # {'RS': 622, 'BO': 635, 'ASHA': 790}
    "aknn-auc-40701": 733,  # {'RS': 657, 'BO': 144, 'ASHA': 733}
    "aknn-auc-40994": 396,  # {'RS': 161, 'BO': 29, 'ASHA': 396}
    "aknn-auc-23": 426,  # {'RS': 426, 'BO': 53, 'ASHA': 402}
    "aknn-auc-1468": 31,  # {'RS': 16, 'BO': 31, 'ASHA': 23}
    "aknn-auc-40668": 745,  # {'RS': 738, 'BO': 392, 'ASHA': 745}
    "aknn-auc-29": 491,  # {'RS': 381, 'BO': 66, 'ASHA': 491}
    "aknn-auc-31": 826,  # {'RS': 826, 'BO': 784, 'ASHA': 102}
    ...
    "aknn-auc-41159": 855,  # {'RS': 270, 'BO': 679, 'ASHA': 855}
    "aknn-auc-1478": 588,  # {'RS': 405, 'BO': 178, 'ASHA': 588}
    "aknn-auc-41169": 787,  # {'RS': 787, 'BO': 222, 'ASHA': 495}
    "aknn-auc-23512": 849,  # {'RS': 508, 'BO': 259, 'ASHA': 849}
    "aknn-auc-41212": 343,  # {'RS': 196, 'BO': 237, 'ASHA': 343}
    "aknn-auc-1480": 442,  # {'RS': 387, 'BO': 94, 'ASHA': 442}
    "aknn-auc-300": 334,  # {'RS': 203, 'BO': 157, 'ASHA': 334}
    "aknn-auc-41168": 726,  # {'RS': 726, 'BO': 259, 'ASHA': 714}
    ...
    "aknn-auc-41161": 757,  # {'RS': 288, 'BO': 757, 'ASHA': 337}
    "aknn-auc-41165": 875,  # {'RS': 301, 'BO': 829, 'ASHA': 875}
    "aknn-auc-182": 211,  # {'RS': 211, 'BO': 39, 'ASHA': 123}
    "aknn-auc-312": 216,  # {'RS': 51, 'BO': 19, 'ASHA': 216}
    "aknn-auc-40984": 86,  # {'RS': 81, 'BO': 18, 'ASHA': 86}
    "aknn-auc-1501": 119,  # {'RS': 119, 'BO': 43, 'ASHA': 42}
    "aknn-auc-38": 637,  # {'RS': 637, 'BO': 30, 'ASHA': 619}
    "aknn-auc-42": 25,  # {'RS': 15, 'BO': 6, 'ASHA': 25}
    ...
    "aknn-auc-41216": 863,  # {'RS': 863, 'BO': 218, 'ASHA': 592}
    "aknn-auc-41166": 551,  # {'RS': 551, 'BO': 327, 'ASHA': 120}
    "aknn-auc-1497": 814,  # {'RS': 276, 'BO': 329, 'ASHA': 814}
    "aknn-auc-60": 869,  # {'RS': 542, 'BO': 869, 'ASHA': 519}
    "aknn-auc-1510": 41,  # {'RS': 6, 'BO': 6, 'ASHA': 41}
    "aknn-auc-40983": 147,  # {'RS': 147, 'BO': 24, 'ASHA': 147}
    "aknn-auc-40498": 628,  # {'RS': 628, 'BO': 305, 'ASHA': 263}
    "aknn-auc-181": 727,  # {'RS': 562, 'BO': 428, 'ASHA': 727}
...
def yahpo_rbv2_rpart_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_benchmark_definitions("rpart", restrict_fidelities)


def yahpo_rbv2_rpart_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_selected_benchmark_definitions("rpart", restrict_fidelities)


def yahpo_rbv2_glmnet_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_benchmark_definitions("glmnet", restrict_fidelities)


def yahpo_rbv2_glmnet_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_selected_benchmark_definitions("glmnet", restrict_fidelities)


def yahpo_rbv2_ranger_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_benchmark_definitions("ranger", restrict_fidelities)


def yahpo_rbv2_ranger_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_selected_benchmark_definitions("ranger", restrict_fidelities)


def yahpo_rbv2_xgboost_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_benchmark_definitions("xgboost", restrict_fidelities)


def yahpo_rbv2_xgboost_selected_benchmark_definitions(
    restrict_fidelities=False,
) -> dict:
    return yahpo_rbv2_selected_benchmark_definitions("xgboost", restrict_fidelities)


def yahpo_rbv2_svm_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_benchmark_definitions("svm", restrict_fidelities)


def yahpo_rbv2_svm_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_selected_benchmark_definitions("svm", restrict_fidelities)


def yahpo_rbv2_aknn_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_benchmark_definitions("aknn", restrict_fidelities)


def yahpo_rbv2_aknn_selected_benchmark_definitions(restrict_fidelities=False) -> dict:
    return yahpo_rbv2_selected_benchmark_definitions("aknn", restrict_fidelities)
